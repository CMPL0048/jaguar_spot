...
class AdminController extends Controller
{
    public function index()
    {
        ...
        $reservasPendientes = Estacionamiento::with([
            'puestos.reserva' => function ($query) {
                $query->where('estado', 'pendiente');
            }
        ])->get()->unique('nombre');

        // Obtener los puestos ocupados FILTRANDO SOLO LOS QUE TIENEN UNA RESERVA ACTIVA
        $puestosOcupados = Estacionamiento::with([
    ...
    public function getDashboardData()
    {
        ...
        $reservasPendientes = Estacionamiento::with([
            ...
            'puestos.reserva.usuario'
        ])->get()->unique('nombre')->values();
        ...
        $puestosOcupados = Estacionamiento::with([
            ...
            'puestos.reserva.usuario'
        ])->whereHas('puestos.reserva', function ($query) {
