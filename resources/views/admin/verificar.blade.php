    ...
    @if($reserva)
        <div class="reserva-info">
            ...
            <div class="puesto-info {{ $reserva->puesto->tipo === 'discapacitado' ? 'puesto-discapacitado' : 'puesto-normal' }}">
                ...
                <p class="puesto-tipo">{{ $reserva->puesto->tipo === 'discapacitado' ? __('messages.spot_for_disabled') : __('messages.normal_spot_tag') }}</p>
            </div>
            ...
            <div class="detalles-usuario">
                ...
                <p><strong>⏳ {{ __('messages.state') }}:</strong> <span class="estado-{{ $reserva->estado }}">{{ ucfirst($reserva->estado) }}</span></p>
