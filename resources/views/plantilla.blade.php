...
<body>
    <header>
        <div class="curved-green">
            ...
            <svg xmlns="{{asset('http://www.w3.org/2000/svg')}}" viewBox="0 0 1440 250"><path fill="#0d0e0d" fill-opacity="1" d="M0,192L120,165.3C240,139,480,85,720,85.3C960,85,1200,139,1320,165.3L1440,192L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z"></path></svg>
        </div>
    </header>
    ...
    <footer>
        <div class="curved-green">
            <svg xmlns="{{asset('http://www.w3.org/2000/svg')}}" viewBox="0 0 1440 319"><path fill="#0d0e0d" fill-opacity="1" d="M0,160L120,170.7C240,181,480,203,720,197.3C960,192,1200,160,1320,144L1440,128L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z">
            </path></svg>    
        </div>
    </footer>
</body>
